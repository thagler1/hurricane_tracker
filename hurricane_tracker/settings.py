"""
Django settings for hurricane_tracker project.
...
import os
from hurricane_tracker import settings_secret
...
ROOT_URLCONF = 'hurricane_tracker.urls'
...
WSGI_APPLICATION = 'hurricane_tracker.wsgi.application'
...
CRONJOBS = [
    ('30 18 * * *', 'hurricane_tracker.cron.noaa_ftp'),
    ('30 21 * * *', 'hurricane_tracker.cron.noaa_ftp'),
